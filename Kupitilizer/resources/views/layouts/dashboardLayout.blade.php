        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-dark text-leaf">
            <ul class="space-y-2 font-bold">
                ...
                <li>
                    ...
                    <span class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">3</span>            </a>
                </li>
                <li>
