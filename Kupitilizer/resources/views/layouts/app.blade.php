                    ...
                    <div class="px-6 py-6 lg:px-8">
                        ...
                        <form class="space-y-6" action="#">
                            ...
                            <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                                <button data-modal-target="register-modal" data-modal-toggle="register-modal" class="block px-4 py-1 sm:py-2 bg-leaf hover:bg-leaf hover:text-dark text-white font-bold rounded-xl" type="button">
                                    Register
                                </button>
                            </div>
                        </form>
