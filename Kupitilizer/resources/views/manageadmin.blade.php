        ...
        <table class="w-full text-sm text-left text-gray-500 ">
            ...
            <tr class="bg-white hover:bg-gray-50 rounded-xl">
                    ...
                    <td class="px-6 py-4 flex gap-1">
                        <!-- Modal toggle -->
                        <a href="#" type="button" data-modal-target="editAdminModal" data-modal-show="editAdminModal" class="bg-leaf text-white font-bold rounded-md px-4 py-2">Edit</a>
                ...
                <tr class="bg-white hover:bg-gray-50 rounded-xl">
                    ...
                    <td class="px-6 py-4 flex gap-1">
                        <!-- Modal toggle -->
                        <a href="#" type="button" data-modal-target="editUAdminModal" data-modal-show="editAdminModal" class="bg-leaf text-white font-bold rounded-md px-4 py-2">Edit</a>
                        <a href="#" type="button" class="bg-red-400 text-white font-bold rounded-md px-4 py-2">Delete</a>                    
                    </td>
                </tr>
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" method="POST" action="{{ route('register') }}">
                    ...
                    <button type="submit" name="addadmin" class="mb-px w-full text-white bg-leaf focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Tamabah Admin</button>
                </form>
            </div>
        </div>
    </div>
...
<div id="editAdminModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
    <div class="relative w-full h-full max-w-2xl md:h-auto">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow">
            <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-hide="register-modal">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" method="POST" action="{{ route('register') }}">
                    ...
                    <button type="submit" name="addadmin" class="mb-px w-full text-white bg-leaf focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Edit Admin</button>
                </form>
            </div>
        </div>
    </div>
...
if (isset($_POST['addadmin'])){
    ...
    if($queryinsert){
        //if berhasil
        header('location:manageadmin.blade.php');
