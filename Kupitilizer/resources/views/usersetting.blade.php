    ...
    <div class="m-10 py-5 shadow-2xl border-2 border-gray rounded-xl p-5">
        ...
        <div class="grid grid-cols-2">
            <div class="px-4 py-2 font-semibold">Nama</div>
                <div class="px-4 py-2">
                <input type="text" class="w-full px-4 py-2 border border-gray-300 rounded-md" value="{{Auth::user()->name}}">
            </div>
</div>
            <div class="grid grid-cols-2">
                <div class="px-4 py-2 font-semibold">Jenis Kelamin</div>
                <div class="px-4 py-2">
                <input type="text" class="w-full px-4 py-2 border border-gray-300 rounded-md" value="">
            </div>
            </div>
            <div class="grid grid-cols-2">
            ...
            <div class="grid grid-cols-2">
                ...
                <div class="px-4 py-2">
                <input type="text" class="w-full px-4 py-2 border border-gray-300 rounded-md" value="{{Auth::user()->email}}">
            </div>
            </div>
            <div class="grid grid-cols-2">
