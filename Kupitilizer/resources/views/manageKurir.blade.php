...
<li>
    <div class="flex items-center">
        <svg aria-hidden="true" class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
        <a href="#" class="ml-1 text-sm font-medium text-gray-700 hover:text-leaf md:ml-2 dark:text-gray-400 dark:hover:text-white">Manage Kurir</a>
    </div>
</li>
@endsection
                ...
                <tbody>
                    ...
                    <tr class="bg-white hover:bg-gray-50 rounded-xl">
                        ...
                        <td class="px-6 py-4 flex gap-1">
                            ...
                            <!-- Edit button -->
                            <form action="/<?php echo Auth::user()->role?>/managekurir/edit/{{ $item->email }}" method="get" class='d-inline'>
                                @method('get')
                                @csrf
                            ...
                            <!-- Delete button -->
                            <form action="/<?php echo Auth::user()->role?>/managekurir/delete/{{ $item->email }}" method="post" class='d-inline'>
                                @method('delete')
                                @csrf
    ...
    <div class="relative w-full h-full max-w-2xl md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <!-- Form add user -->
                <form class="space-y-6" method="POST" action="/<?php echo Auth::user()->role?>/managekurir">
                    @csrf
                    <div>
                        <!-- Nama -->
                        <div class="my-4">
