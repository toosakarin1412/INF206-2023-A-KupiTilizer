                ...
                @foreach($dataRequest as $item)
                    <tr class="bg-white hover:bg-gray-50 rounded-xl">
                        ...
                        <td class="px-6 py-4 flex gap-1">
                            ...
                            <form action="/<?php echo Auth::user()->role?>/pembelian/done/{{$item->id}}" method="get" class='d-inline'>
                                <button type="submit" class="bg-green-300 text-white font-bold rounded-md px-4 py-2">Done</button>
                            </form>
                            @endif
                        </td>
                    </tr>
