...
@foreach($products as $item)
    <div class = "relative overflow-x-auto shadow-md sm:rounded-lg sm:p-4 text-gray-700 border border-gray-200 bg-gray-50">
        ...
        <h1 class = "text-center font-bold text-3xl">{{$item-> nama_product}}</h1>
        <p class = "font-semibold text-xl text-right my-6 mt-7">Rp{{$item-> harga}},00</p>       
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" method="POST" action="/admin/product/addproduct">
                    ...
                    <div class="sm:grid">
                        <!-- nama product -->
                        <div class="sm:mr-5">
                            <label for="nama_product" class="block mb-2 text-sm font-medium text-gray-900">Nama Product</label>
                            <input type="nama_product" name="nama_product" id="nama_product" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Masukkan Product Anda" required>
                        </div>
                        <!-- harga product -->
                        <div class="sm:mr-5">
                            <label for="harga" class="block mb-2 text-sm font-medium text-gray-900">Harga Product</label>
                            <input type="harga" name="harga" id="harga" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Masukkan Harga" required>
                        </div>
                        <!-- deskripsi product -->
                        <div class="sm:mr-5">
                    ...
                    <!-- Submit tambahkan -->
                    <button type="submit" class="mb-px w-full text-white bg-leaf focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                </form>
            </div>
        </div>
    </div>
